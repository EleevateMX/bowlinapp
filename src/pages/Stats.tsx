...
export default function Stats() {
  return (
    <div className="animate-fade-in-up space-y-6">
      <PageHeader
        title="Estadísticas"
        subtitle="Tu rendimiento en números"
      />
      ...
      <section className="grid grid-cols-2 gap-3">
        <StatCard
          ...
          accent
        />
        <StatCard label="Mejor score" value={mockStats.bestScore} />
      </section>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Rendimiento por tiro</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <RateRow label="Strike rate" value={mockStats.strikeRate} />
            <RateRow label="Spare rate" value={mockStats.spareRate} />
            <RateRow label="Open frames" value={mockStats.openFrameRate} />
          </CardContent>
        </Card>
      </PlanGate>
